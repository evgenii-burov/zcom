...
class Tile:
    def __init__(self, grid_point: Point):
...
def to_pixel(grid_point: Point) -> Point:
    return Point(grid_point.x * TILE_SIZE, grid_point.y * TILE_SIZE)


def to_grid(pixel_point: Point) -> Point:
    return Point(pixel_point.x // TILE_SIZE, pixel_point.y // TILE_SIZE)
